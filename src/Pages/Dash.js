...
const Dash = () => {
  ...
  return (
    <div className="w-screen h-screen">
      <div className="w-full h-72 bg-red-700">
      ...
      <div>
        <div className="w-7/12 mx-auto my-14 ">
          <form onSubmit={submitHandler} className="w-11/12 mx-auto flex flex-col items-center">
            <div className="relative w-full">
              ...
              ></input>
              {toggle && (
                <p className="pl-1 absolute top-4 text-xl">{preText}</p>
              )}
            </div>
